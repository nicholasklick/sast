...
BENCHMARKS = {
    ...
    "php": BenchmarkConfig(
        language="php",
        source_path="../owasp/BenchmarkPHP/testcode",
        expected_results="../owasp/BenchmarkPHP/expectedresults-0.1.csv",
        file_extension=".php",
        category_mapping=PYTHON_CATEGORIES,
    ),
    "csharp": BenchmarkConfig(
        language="csharp",
        source_path="../owasp/BenchmarkCSharp/testcode",
        expected_results="../owasp/BenchmarkCSharp/expectedresults-0.1.csv",
        file_extension=".cs",
        category_mapping=PYTHON_CATEGORIES,
    ),
}
